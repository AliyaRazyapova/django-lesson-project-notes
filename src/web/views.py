...
from src.web.forms import NoteForm, AuthForm
from src.web.models import Note, Tag, User


class NotesListView(ListView):
    template_name = 'web/templates/web/main.html'
...
class NoteDetailView(DetailView):
    template_name = 'web/templates/web/note.html'
    slug_field = 'id'
    slug_url_kwarg = 'id'
...
class NoteDeleteView(NoteMixin, DeleteView):
    template_name = 'web/templates/web/note_delete.html'
...
class RegistrationView(View):
    def _render(self, request, form=None, is_success=False):
        return render(request, "web/templates/web/registration.html", {
...
def login_view(request):
    ...
    return render(request, "web/templates/web/login.html", {
        "form": form,
        'message': message
    })
...
def html_view(request):
    return render(request, "web/templates/web/html.html")


@login_required
def stat_view(request):
    notes = Note.objects.filter(user=request.user)
    return render(request, "web/templates/web/stat.html", notes.aggregate(
        count=Count("id"),
